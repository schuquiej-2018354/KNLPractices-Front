    ...
    return (
        <>
            <div className="d-flex align-items-start" style={{ width: '100%', marginTop: '1rem' }}>
                ...
                <div className="card flex-row mb-3 comment-container" style={{ marginLeft: '0.5rem' }}>
                    <div className="card-body text-black" style={{ width: '100%' }}>
                                ...
                                dataUser.id == idUser ? (
                                    <>
                                        <p className="text-end" onClick={(() => deleteCommet(_id))} style={{ cursor: 'pointer' }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" className="bi bi-trash3" viewBox="0 0 16 16" style={{ fill: 'black' }}>
